...
//        referencesButton.layer.borderColor = referencesButton.tintColor.cgColor
        ...
        logoutButton.tintColor = UIColor(colorLiteralRed: 0, green: 0, blue: 0, alpha: 0)
        ...
        examinationButton.addTarget(self, action: #selector(examinationButtonClicked), for: .touchUpInside)
